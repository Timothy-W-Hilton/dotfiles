...
#  Choices: any of ['blake2s', 'md5', 'sha3_384', 'sha3_224', 'blake2b', 'sha512', 'sha256', 'sha3_512', 'sha384', 'sha3_256', 'sha224', 'sha1']
#  Default: 'sha256'
...
# save in both ipynb, R markdown format.  Added 25 Aug 2021 --TWH
